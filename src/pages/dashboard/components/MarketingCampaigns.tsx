...
const initialCampaigns: Campaign[] = [
  { id: '1', name: 'Summer Sale', type: 'Discount', startDate: new Date(2025, 5, 1), endDate: new Date(2025, 7, 31), budget: 5000, status: 'Active' },
  { id: '2', name: 'Back to School', type: 'Bundle', startDate: new Date(2025, 7, 15), endDate: new Date(2025, 8, 15), budget: 3000, status: 'Scheduled' },
  { id: '3', name: 'Spring Collection Launch', type: 'New Product', startDate: new Date(2025, 2, 1), endDate: new Date(2025, 3, 30), budget: 8000, status: 'Ended' },
]

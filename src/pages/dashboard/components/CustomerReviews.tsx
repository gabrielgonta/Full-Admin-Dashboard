...
const initialReviews: Review[] = [
  { id: '1', customerName: 'John Doe', customerAvatar: '/avatars/john-doe.png', productName: 'Running Shoe X1', rating: 5, comment: 'Great shoes! Very comfortable for long runs.', date: new Date(2025, 5, 15), helpful: 10, notHelpful: 1, status: 'Published' },
  { id: '2', customerName: 'Jane Smith', customerAvatar: '/avatars/jane-smith.png', productName: 'Casual Sneaker Y2', rating: 3, comment: 'Decent shoes, but not as durable as I expected.', date: new Date(2025, 5, 20), helpful: 5, notHelpful: 2, status: 'Published' },
  { id: '3', customerName: 'Mike Johnson', customerAvatar: '/avatars/mike-johnson.png', productName: 'Hiking Boot Z3', rating: 4, comment: 'Good grip on rough terrain. Could use more ankle support.', date: new Date(2025, 5, 25), helpful: 8, notHelpful: 1, status: 'Pending' },
]

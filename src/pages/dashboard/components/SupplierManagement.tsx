...
const initialSuppliers: Supplier[] = [
  { id: '1', name: 'ShoeMax Inc.', contact: 'John Smith', email: 'john@shoemax.com', phone: '(555) 123-4567', products: ['Running Shoes', 'Sneakers'], status: 'Active', lastOrderDate: new Date(2025, 5, 15) },
  { id: '2', name: 'Sole Providers LLC', contact: 'Jane Doe', email: 'jane@soleproviders.com', phone: '(555) 987-6543', products: ['Hiking Boots', 'Sandals'], status: 'Active', lastOrderDate: new Date(2025, 5, 20) },
  { id: '3', name: 'Lace Masters Co.', contact: 'Bob Johnson', email: 'bob@lacemasters.com', phone: '(555) 246-8135', products: ['Shoelaces', 'Insoles'], status: 'Inactive', lastOrderDate: new Date(2025, 4, 10) },
]

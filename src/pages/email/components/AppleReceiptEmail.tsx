...
const AppleReceiptEmail: React.FC<EmailProps> = ({ userEmail }) => (
    <Html>
        <Head />
                            ...
                            <Section>
                                ...
                                <Row>
                                    <Column style={informationTableColumn}>
                                        ...
                                        <Text style={informationTableValue}>18 Jan 2025</Text>
                                    </Column>
                                </Row>
                ...
                <Section>
                    <Row>
                        ...
                        <Column style={{ paddingLeft: "22px" }}>
                            ...
                            <Text style={productDescription}>Renews Aug 20, 2025</Text>
                            <Link

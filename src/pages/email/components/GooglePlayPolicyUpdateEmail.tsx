...
export const GooglePlayPolicyUpdateEmail: React.FC<EmailProps> = ({ userEmail }) => (
  <Html>
    <Head />
      ...
      <Container style={container}>
        ...
        <Section style={paragraphContent}>
          <Text style={paragraph}>
            ...
            start experiencing reduced distribution starting <b>Jan 31, 2025</b>{" "}
